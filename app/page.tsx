      ...
      <div className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-slate-950/70 backdrop-blur-xl">
        <nav className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/login"
              className="hidden items-center justify-center rounded-full border border-white/20 bg-transparent px-4 py-2.5 text-sm font-semibold text-slate-100 transition-all duration-300 hover:border-cyan-400/50 hover:bg-white/5 hover:text-cyan-300 md:inline-flex"
            >
              Acceso Clientes
            </Link>
          ...
          <div className="border-t border-white/5 bg-slate-950/95 backdrop-blur-xl md:hidden">
            <div className="mx-auto max-w-7xl px-4 py-2 sm:px-6">
              ...
              <Link
                href="/login"
                onClick={() => setIsMenuOpen(false)}
                className="block border-b border-white/5 py-5 text-center text-lg font-semibold text-slate-100 transition-colors hover:text-cyan-300"
              >
                Acceso Clientes
              </Link>
              <a
